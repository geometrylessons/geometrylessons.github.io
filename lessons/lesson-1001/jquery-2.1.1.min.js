!(function (e, t) {
        ...
        return i !== d && 9 === i.nodeType && i.documentElement
          ? ((d = i),
            ...
            (r.find.CLASS =
              n.getElementsByClassName &&
              function (e, t) {
                return typeof t.getElementsByClassName !== j && g
      ...
      var n = t.length > 0,
        ...
        o = function (o, s, a, u, c) {
          ...
          if (((g += m), n && m !== g)) {
            ...
            if (o) {
              if (g > 0) for (; m--; ) v[m] || y[m] || (y[m] = q.call(u));
              y = ye(y);
            }
            O.apply(u, y),
              c && !o && y.length > 0 && g + t.length > 1 && ie.uniqueSort(u);
          }
          return c && ((T = w), (l = x)), v;
        };
      return n ? se(o) : o;
    ...
    return (
      ...
      (u = ie.select =
        function (e, t, i, o) {
          ...
          return (
            (d || a(e, h))(o, t, !g, i, (ee.test(e) && de(t.parentNode)) || t),
            i
          );
        }),
    ...
    d.fn.extend({
      find: function (e) {
        ...
        if ("string" != typeof e)
          return this.pushStack(
            d(e).filter(function () {
              for (t = 0; n > t; t++) if (d.contains(i[t], this)) return !0;
            })
          );
    ...
    d.fn.extend({
      has: function (e) {
        ...
        return this.filter(function () {
          for (var e = 0; n > e; e++) if (d.contains(this, t[e])) return !0;
        });
      },
  ...
  (d.event = {
        ...
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)),
            ...
            (s = v.handle) ||
              (s = v.handle =
                function (t) {
                  return typeof d !== z && d.event.triggered !== t.type
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        3 !== r.nodeType &&
          8 !== r.nodeType &&
          !V.test(m + d.event.triggered) &&
          (m.indexOf(".") >= 0 && ((m = (v = m.split(".")).shift()), v.sort()),
          (c = m.indexOf(":") < 0 && "on" + m),
          ((t = t[d.expando]
            ? t
        ...
        if (!i && !h.noBubble && !d.isWindow(r)) {
          for (
            u = h.delegateType || m, V.test(u + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            g.push(s), (a = s);
    ...
    fix: function (e) {
      ...
      for (
        s ||
          (this.fixHooks[i] = s =
            U.test(i) ? this.mouseHooks : X.test(i) ? this.keyHooks : {}),
  ...
  (se.optgroup = se.option),
    ...
    d.extend({
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (s = pe(a), r = 0, i = (o = pe(e)).length; i > r; r++)
            de(o[r], s[r]);
        if (t)
          if (n)
            for (
              o = o || pe(e), s = s || pe(a), r = 0, i = o.length;
              i > r;
              r++
            )
              fe(o[r], s[r]);
        ...
        return (
          (s = pe(a, "script")).length > 0 && ce(s, !u && pe(e, "script")), a
        );
      },
    ...
    d.fn.extend({
      ...
      remove: function (e, t) {
        for (
          ...
          t || 1 !== n.nodeType || d.cleanData(pe(n)),
            n.parentNode &&
              (t && d.contains(n.ownerDocument, n) && ce(pe(n, "script")),
              n.parentNode.removeChild(n));
        return this;
      },
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (d.cleanData(pe(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return H(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !te.test(e) &&
              !se[(Z.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = e.replace(K, "<$1></$2>");
              try {
                for (; r > n; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (d.cleanData(pe(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      domManip: function (e, t) {
        ...
        if (
          ...
          for (s = (o = d.map(pe(n, "script"), ue)).length; f > l; l++)
            (a = n),
              l !== h &&
                ((a = d.clone(a, !0, !0)), s && d.merge(o, pe(a, "script"))),
              t.call(this[l], a, l);
          if (s)
            for (
              u = o[o.length - 1].ownerDocument, d.map(o, le), l = 0;
              s > l;
              l++
            )
              (a = o[l]),
                re.test(a.type || "") &&
                  ...
                  (a.src
                    ...
                    : d.globalEval(a.textContent.replace(oe, "")));
        }
        return this;
      },
    }),
    d.each(
      ...
      function (e, t) {
        d.fn[e] = function (e) {
          for (var n, r = [], i = d(e), s = i.length - 1, a = 0; s >= a; a++)
  ...
  function ve(e) {
    ...
    return (
      n ||
        (("none" !== (n = me(e, t)) && n) ||
          ((t = (he = (
            he || d("<iframe frameborder='0' width='0' height='0'/>")
  ...
  function we(e, t, n) {
    var r,
      ...
      a = e.style;
    return (
      (n = n || be(e)) && (s = n.getPropertyValue(t) || n[t]),
      n &&
      ...
      "margin" === n && (s += d.css(e, n + B[o], !0, i)),
        r
          ? ("content" === n && (s -= d.css(e, "padding" + B[o], !0, i)),
            "margin" !== n && (s -= d.css(e, "border" + B[o] + "Width", !0, i)))
  ...
  function qe(e, t, n) {
    ...
    if (0 >= i || null == i) {
      if (
        ((0 > (i = we(e, t, o)) || null == i) && (i = e.style[t]), xe.test(i))
      )
        return i;
      ...
      (r = e[s]).style &&
        ...
        t
          ? (o[s] || "none" !== n || (r.style.display = ""),
            "" === r.style.display &&
              I(r) &&
              (o[s] = F.access(r, "olddisplay", ve(r.nodeName))))
          : ((i = I(r)),
            ("none" === n && i) ||
  ...
  d.extend({
    ...
    d.each(["height", "width"], function (e, t) {
      d.cssHooks[t] = {
        get: function (e, n, r) {
          return n
            ? Ce.test(d.css(e, "display")) && 0 === e.offsetWidth
              ? d.swap(e, Ee, function () {
                  return qe(e, t, r);
                })
              : qe(e, t, r)
            : void 0;
        ...
        set: function (e, n, r) {
          ...
          return Ae(
            ...
            n,
            r
              ? Le(e, t, r, "border-box" === d.css(e, "boxSizing", !1, i), i)
              : 0
          );
        },
      };
    ...
    (d.cssHooks.marginRight = Te(c.reliableMarginRight, function (e, t) {
      return t
        ? d.swap(e, { display: "inline-block" }, we, [e, "marginRight"])
        : void 0;
    })),
    ...
    $e = [
      function (e, t, n) {
        ...
        1 === e.nodeType &&
          ...
          "inline" ===
            ("none" === (l = d.css(e, "display"))
              ? F.get(e, "olddisplay") || ve(e.nodeName)
              : l) &&
            "none" === d.css(e, "float") &&
        ...
        if (d.isEmptyObject(f))
          "inline" === ("none" === l ? ve(e.nodeName) : l) && (p.display = l);
        else
          for (r in (g
  ...
  function ze(e, t, n) {
    for (
      var r, i = (Be[t] || []).concat(Be["*"]), o = 0, s = i.length;
      s > o;
      o++
    )
  ...
  (d.Animation = d.extend(Xe, {
    tweener: function (e, t) {
      ...
      for (var n, r = 0, i = e.length; i > r; r++)
        (n = e[r]), (Be[n] = Be[n] || []), Be[n].unshift(t);
    },
        ...
        if (e && 3 !== o && 8 !== o && 2 !== o)
          return typeof e.getAttribute === z
            ...
            : ((1 === o && d.isXMLDoc(e)) ||
                ((t = t.toLowerCase()),
                (r =
                  d.attrHooks[t] || (d.expr.match.bool.test(t) ? Ue : void 0))),
              void 0 === n
  ...
  d.fn.extend({
    ...
    d.extend({
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            return e.hasAttribute("tabindex") || Ye.test(e.nodeName) || e.href
              ? e.tabIndex
              : -1;
          },
        },
  ...
  d.fn.extend({
      ...
      if (a)
        for (t = (e || "").match(A) || []; l > u; u++)
          if (
            (r =
              1 === (n = this[u]).nodeType &&
              (n.className ? (" " + n.className + " ").replace(Ge, " ") : " "))
          ) {
            for (o = 0; (i = t[o++]); )
              r.indexOf(" " + i + " ") < 0 && (r += i + " ");
    ...
    hasClass: function (e) {
      for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++)
        if (
          1 === this[n].nodeType &&
          (" " + this[n].className + " ").replace(Ge, " ").indexOf(t) >= 0
        )
          return !0;
      return !1;
    },
  ...
  d.fn.extend({
    ...
    d.each(["radio", "checkbox"], function () {
      (d.valHooks[this] = {
        set: function (e, t) {
          return d.isArray(t)
            ? (e.checked = d.inArray(d(e).val(), t) >= 0)
            : void 0;
        },
      }),
        c.checkOn ||
      ...
      ajax: function (e, t) {
        ...
        if (
          ...
          (c.dataTypes = d
            ...
            .match(A) || [""]),
          null == c.crossDomain &&
            ((a = st.exec(c.url.toLowerCase())),
            (c.crossDomain = !(
              !a ||
              (a[1] === Ze[1] &&
                a[2] === Ze[2] &&
                (a[3] || ("http:" === a[1] ? "80" : "443")) ===
                  (Ze[3] || ("http:" === Ze[1] ? "80" : "443")))
            ))),
          c.data &&
            c.processData &&
        ...
        c.hasContent ||
          (c.data &&
            ((r = c.url += (Ke.test(r) ? "&" : "?") + c.data), delete c.data),
          !1 === c.cache &&
            (c.url = nt.test(r)
              ? r.replace(nt, "$1_=" + Je++)
              : r + (Ke.test(r) ? "&" : "?") + "_=" + Je++)),
  ...
  e.ActiveXObject &&
    ...
    (c.cors = !!Tt && "withCredentials" in Tt),
    (c.ajax = Tt = !!Tt),
      ...
      return a || "jsonp" === t.dataTypes[0]
        ? ((i = t.jsonpCallback =
            d.isFunction(t.jsonpCallback)
              ...
              : t.jsonpCallback),
          a
            ? (t[a] = t[a].replace(Nt, "$1" + i))
            : !1 !== t.jsonp &&
              (t.url += (Ke.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
  ...
  (d.offset = {
    ...
    d.each(["top", "left"], function (e, t) {
      d.cssHooks[t] = Te(c.pixelPosition, function (e, n) {
        return n
          ? ((n = we(e, t)), xe.test(n) ? d(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
