	...
	i.n = e => {
		...
		var Je = function() {
			...
			et = function() {
				...
				return e.prototype.init = function(e) {
					...
					this.isBot = "1" === I("bot"), this.setupDefaultEvents(), at.setupDefaultEvents(), e.GetIsPokiIFrame() && ye(), setTimeout(b.trackSaveG4M3S, 1e4);
					var v = Je({}, d),
						k = je;
					r.debug && (k = function() {
		...
		var pt = function() {
			...
			ht = function() {
				function t() {
					var t = this;
					this.G4M3Started = !1, this.SDK = new tt, this.gameplayStartCounter = 0, this.gameplayStopCounter = 0, this.duringGameplay = !1, this.init = function(e) {
						...
						t.gameplayStartCounter++, t.duringGameplay = !0, t.G4M3Started || (t.G4M3Started = !0, at.track(n.tracking.screen.firstRound), t.SDK.startStartAdsAfterTimer()), at.track(n.tracking.screen.gameplayStart, pt(pt({}, e), {
