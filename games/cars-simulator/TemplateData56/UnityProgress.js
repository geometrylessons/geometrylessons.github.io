...
window.Game = (function () {
  ...
  Game.prototype.resize = function () {
    ...
    var G4M3SizeRatio = gameContainer.offsetWidth / gameContainer.offsetHeight;
    ...
    if (ratioTolerant == "true") {
      ...
      if (G4M3SizeRatio > windowSizeRatio) {
        newStyle = { width: maxWidth, height: maxWidth / G4M3SizeRatio };
      } else {
        newStyle = { width: maxHeight * G4M3SizeRatio, height: maxHeight };
      }
    }
