AddLanguage('JA','japanese',{
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing G4M3S? Here's some ways you can help:%1": "本バージョンのCookie Clickerは、永久に100%無料です。ゲームの開発が継続できるよう支援してみませんか？以下に支援の方法をご紹介します：%1",
	...
	"Confers various powers to your miniG4M3S while active.<br>See the bottom of each minigame for more details.": "アクティブでいる間、さまざまなパワーをミニゲームに送る。<br>詳細はそれぞれのミニゲームの底面を参照。",
