AddLanguage('RU','russian',{
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing G4M3S? Here's some ways you can help:%1": "Эта версия Cookie Clicker абсолютно бесплатна — навсегда. Хотите поддержать нас, чтобы мы могли продолжать разработку игр? Вот несколько способов, как вы можете нам помочь:%1",
	...
	"Confers various powers to your miniG4M3S while active.<br>See the bottom of each minigame for more details.": "Наделяет различными способностями в минииграх.<br>С подробностями можно ознакомиться внизу каждой миниигры.",
