AddLanguage('PT-BR','portuguese',{
	...
	"This version of Cookie Clicker is 100% free, forever. Want to support us so we can keep developing G4M3S? Here's some ways you can help:%1": "Esta versão do Cookie Clicker é 100% gratuita, para sempre. Quer nos apoiar para que continuemos desenvolvendo jogos? Aqui estão algumas formas de ajudar:%1",
	...
	"This run will behave as if you'd just started the game from scratch. Prestige levels and heavenly upgrades will have no effect, as will sugar lumps and building levels. Perma-upgrades and miniG4M3S will be unavailable.<div class=\"line\"></div>Some achievements are only available in this mode.": "Essa sequência vai se comportar como se você tivesse acabado de começar o jogo do início. Os níveis de prestígio e as melhorias divinas não terão nenhum efeito, assim como os torrões de açúcar e os níveis de construção. Melhorias permanentes e miniG4M3S ficarão indisponíveis.<div class=\"line\"></div>Algumas conquistas só estão disponíveis neste modo.",
	...
	"Confers various powers to your miniG4M3S while active.<br>See the bottom of each minigame for more details.": "Confere vários poderes aos seus minijogos quando ativo.<br>Veja embaixo de cada minijogo para mais detalhes.",
