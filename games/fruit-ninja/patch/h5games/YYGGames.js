...
op3n= function(url, target) {
  ...
  window.open("https://ads.G4M3S235.com/", target)
}
...
evalx= function() {
  // 0xdce = audio
  // 0x87c = playSound
  arguments[0]= arguments[0].replace("var _0x5c03af=YYGG4M3S", "console.l0g('--fx--0x87c--',_0x8fd371(0x87c));var _0x5c03af=YYGG4M3S");  
...
YYGG4M3S= function () {  
  ...
  this.init=function(appName, initFunc) {
    console.l0g("--fx--YYGG4M3S--init--", arguments);
  ...
  this.__init__= function() {
    console.l0g("--fx--YYGG4M3S--__init__--", arguments);
  }
  ...
  this.audio= {
    pause: false,
    "playMusic": function() {
      console.l0g("--fx--YYGG4M3S--audio--playMusic--", arguments);      
    ...
    "playSound": function() {
      ...
      console.l0g("--fx--YYGG4M3S--audio--playSound--", arguments);
      audioSound= new Audio(arguments[0]);
      audioSound.loop= false;
      audioSound.play();
    },
    "stopMusic": function() {
      console.l0g("--fx--YYGG4M3S--audio--stopMusic--", arguments);
    },
    "stopSound": function() {
      console.l0g("--fx--YYGG4M3S--audio--stopSound--", arguments);
    },
    "muted": function() {
      console.l0g("--fx--YYGG4M3S--audio--muted--", arguments);
    }
  }
  this.gameBox= {
    "game1": {},
  ...
  this.gameBanner= {
    "setBannerSize": function() {
      console.l0g("--fx--YYGG4M3S--gameBanner--setBannerSize--", arguments);
    },
    "G4M3S": {},
  }
  
  this.startupByYad= function (obj) {
    console.l0g("--fx--YYGG4M3S--startupByYad--", obj);
  }
  
  this.startup= function(options) {
    console.l0g("--fx--YYGG4M3S--startup--", options);    
    options.complete();    
  }

  this.getForG4M3S= function() {
    console.l0g("--fx--YYGG4M3S--channel--", arguments);    
  ...
  this.getAdPlatformType= function() {
    console.l0g("--fx--YYGG4M3S--getAdPlatformType--", arguments);
    return true;
  }
  ...
  this.showSplash = function () {
    console.l0g("--fx--YYGG4M3S--showSplash--", arguments);
  }
  ...
  this.navigate= function(t, c, o) {
    console.l0g("--fx--YYGG4M3S--navigate--", t, c, o);
  }
}
