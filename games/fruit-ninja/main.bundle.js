            ...
            (function(global) { /* harmony export (binding) */
                ...
                class FruitFactory {
                    ...
                    load(path, posX, posY, posZ, scaleSize, id, data) {
                        ...
                        this.scene.third.load.fbx(path).then(object => {
                            ...
                            item.object.body.on.update(() => {
                                ...
                                if (this.scene.G4M3State == -1 || this.scene.G4M3State == 0 || this.scene.G4M3State == 3 || this.scene.G4M3State == 4) {
                                ...
                                } else if (this.scene.G4M3State == 2) {
                                    if (item.willActive) {
                                        this.activate(item);
                        ...
                        if (!fruit.sliced) {
                            ...
                            if (fruit.id == "Bomb" || fruit.id == "BUI") {
                                ...
                                if (fruit.hasSplash) {
                                    ...
                                    if (this.scene.G4M3State == 2 && (Phaser.Math.Between(1, 100) <= 12)) {
                    ...
                    update(delta) {
                        ...
                        if (this.scene.G4M3State == 2 && !this.scene.hitBomb) {
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            class MainScene extends _enable3d_phaser_extension__WEBPACK_IMPORTED_MODULE_0__["Scene3D"] {
                ...
                createCreditsText() {
                    ...
                    let thanksogid = this.add.text(490, startY + sthanksog.height + 5, 'Own G4M3S Indonesia', {
                        fontFamily: 'gangofchinese',
                        fontSize: 28,
                        color: '#693E17',
                        align: 'center'
                    ...
                    if (this.G4M3State == -1) {
                        ...
                        if (this.blade) {
                            ...
                            if (!this.holdCheckUI && !this.homeAnimation) {
                                ...
                                if (resHit == 'WMUI') {
                                    this.blade.changeCurrentScreen("G4M3Screen");
                                    this.moveToGameplay();
                                } else if (resHit == 'KWUI') {
                ...
                loseLife(posX) {
                    if (this.G4M3State == 2 && !this.hitBomb) {
        ...
        (function(module, __webpack_exports__, __webpack_require__) {
            ...
            class PreloadScene extends Phaser.Scene {
                ...
                preload() {
                    ...
                    this.load.audio('UIG4M3Start', 'assets/sound/UIG4M3Start.mp3');
