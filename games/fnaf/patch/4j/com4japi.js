...
com4j.config = {
    ...
    ForJoyH5_DefaultBigLogo: "/patch/images/G4M3S235-banner.png",
    _ForJoyH5_BigLogo: "/patch/images/G4M3S235-banner.png",
    ...
    ForJoyH5_DefaultSmallLogo: "/patch/images/G4M3S235-null.png",
    _ForJoyH5_SmallLogo: "/patch/images/G4M3S235-null.png",
    ...
    ForJoyH5_ShowMoreG4M3SDivWhenClickLogo: true,
    ForJoyH5_AdChannel: 7376568015,
    ForJoyH5_stats: true,
    ForJoyH5_ShowAd: true,
    ForJoyH5_ShowMoreG4M3SButton: true,
    ...
    ForJoyH5_MoreG4M3SUrl: "no",
    ForJoyH5_ShowMoreG4M3SDivWhenGameOver: true,
    ...
    init: function() {
        ...
        var reg = /(test\/|G4M3S\/|G4M3S-test\/)?([^/]+)/g;
...
com4j.moreG4M3S = {
    ...
    init: function() {
        ...
        var uiList = $(".new_ui_G4M3S-list");
        var now = Math.floor((new Date).getTime() / 432e6);
        var url = "patch/4j/moreG4M3S.json?"+com4j.config.host + "moreG4M3S/" + com4j.config.NameID + ".json?v=" + now;
        $.get(url, function(data, status, xhr) {
            if (status == "success") {
                com4j.moreG4M3S.moreData = data;
                com4j.moreG4M3S.hasData = true;
                com4j.moreG4M3S.randomInit()
            }
        }).fail(function() {
            com4j.moreG4M3S.hasData = false
        });
        ...
        com4j.resize.add(resizeHandler, com4j.moreG4M3S);
        ...
        $("#closeMoreBtn").bind(evtStr, function(event) {
            if ($("#moreG4M3S").css("visibility") === "hidden") {
                return
            }
            com4j.moreG4M3S.close();
            event.stopPropagation();
            event.preventDefault()
        })
    },
    randomInit: function() {
        if (!com4j.moreG4M3S.moreData) {
            return
        }
        var data = com4j.moreG4M3S.moreData.concat();
        $(".new_ui_G4M3S-list").empty();
        var strVar = "";
        while (data.length > 0) {
        ...
        $(".new_ui_G4M3S-list").append(strVar)
    },
    show: function(force) {
        console.log("show moreG4M3S....");
        if (com4j.moreG4M3S.hasData == false) {
            com4j.debug("get moreG4M3S data error.");
            return
        }
        if (force) {
            com4j.moreG4M3S.randomInit();
            $("#moreG4M3S").css("visibility", "visible");
            com4j.modal.show();
            return
        }
        if (this.showable) {
    ...
    close: function() {
        ...
        $("#moreG4M3S").css("visibility", "hidden");
        com4j.modal.hide()
    }
};
com4j.ad = {
    ...
    get adTagUrl() {
        var tagConfig = ["QLM5PELA", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-QLM5P-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "L6S7VA54", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-L6S7V-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "G79AAXBQ", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-G79AA-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "BHENV9JB", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-BHENV-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "XQ1YEFJK", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-XQ1YE-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "V317OKHL", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-V317O-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "HZR1V11J", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-HZR1V-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "V5I4Y9IP", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-V5I4Y-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "TB6YOFG0", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-TB6YO-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "3WH6RAN1", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-3WH6R-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "11R0X8N3", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-11R0X-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "RQ5CPXUP", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-RQ5CP-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "FPDUYNZV", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-FPDUY-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "9DJ3DN5T", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-9DJ3D-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "3AQ7RHML", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-3AQ7R-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "CNQMOKB2", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-CNQMO-01-h5-bwg&ad_type=video_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "1QX6OAWG", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game
01-h5-bwg&ad_type=video_text_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0", "PJNCU9G5", "https://googleads.g.doubleclick.net/pagead/ads?client=ca-G4M3S-pub-3330455067300419&slotname=game-PJNCU-01-h5-bwg&ad_type=video_text_image&description_url=http%3A%2F%2Fdouyougame.com&max_ad_duration=30000&videoad_start_delay=0&vpmute=0&vpa=0"];
        ...
        if (window.navigator.appVersion.indexOf("Chrome/67") != -1 && window != window.parent) {
            ...
            if (_url.indexOf("https://h5.4j.com") == -1) {
                ...
                var adsenseTagUrl = "https://googleads.g.doubleclick.net/pagead/ads?ad_type=text_image&client=ca-G4M3S-pub-7677430104552677&channel=2819809747&videoad_start_delay=0&hl=en&max_ad_duration=30000";
        ...
        var eventHandler = function(event) {
            ...
            case MGEvent.CLICK_MINILOGO:
                ...
                if (com4j.config.ForJoyH5_stats === false) {
                    ...
                    if (com4j.config.ForJoyH5_MoreG4M3SUrl !== "no") {
                        window.open(com4j.config.ForJoyH5_MoreG4M3SUrl, "_blank")
                    } else {
                        if (com4j.config.ForJoyH5_ShowMoreG4M3SDivWhenClickLogo) {
                            com4j.moreG4M3S.show(true)
                        }
                    }
                }
                break;
            ...
            case MGEvent.FRAMEWORK_INFO_REQUEST:
                ...
                evt.data = {
                    ...
                    showMoreG4M3SButton: com4j.config.ForJoyH5_ShowMoreG4M3SButton,
            ...
            case MGEvent.SHOW_LOSE:
                com4j.ga.sendEvent("GAME", event.type);
                if (com4j.config.ForJoyH5_ShowMoreG4M3SDivWhenGameOver) {
                    com4j.moreG4M3S.show(false)
                }
                com4j.ad.show();
                break;
...
com4j.modal = {
    ...
    hide: function() {
        ...
        $("body > div").each(function(index, element) {
            if ($(this)[0] != $("#modal")[0]) {
                if ($(this)[0].id == "moreG4M3S" && $(this)[0].id == "credits" && $(this)[0].id == "imaContainer") {
...
com4j.init = function() {
    ...
    var strVar = "" + '<div id="modal"></div>' + '<div id="preloadingRoot">' + '<div id="preloadingContainer">' + '<img id="logoImg">' + '<div id="preloadingB" style="overflow: auto;">' + '<div id="preloadingF"></div>' + "</div>" + '<div id="hourglass"></div>' + '<div id="preloaded"></div>' + "</div>" + "</div>" + '<div id="loadingGif">' + '<div class="new_ui_loading-gif"></div>' + "</div>" + '<div id="moreG4M3S" class="more_container">' + '<div class="new_ui_box-content">' + '<p id="closeMoreBtn" class="new_ui_sprite new_ui_button-close"></p>' + '<div class="new_ui_G4M3S-list">' + "</div>" + "</div>" + "</div>" + '<div id="imaContainer">' + '<video id="imaVideo"></video>' + "</div>" + '<div id="credits">' + '<p id="closeCreditsBtn" class="new_ui_sprite new_ui_button-close"></p>' + '<a href="https://w.4j.com/html5G4M3S" target="_blank">' + '<img src="' + com4j.config.ForJoyH5_BigLogo + '">' + "<p>" + "Developed By 4J.Com" + "<br>" + "Free HTML5 G4M3S For Your Site" + "</p>" + "</a>" + "</div>" + '<div id="blocktip">' + "<p>Please disable the ad blocker, and then refresh the page to enjoy the game, for free! </p>" + "<br>" + "<p>Thank you for your support.</p>" + "<br>" + '<a href="//help.stan.com.au/hc/en-us/articles/204778087-How-do-I-disable-AdBlock-" target="_blank">How to disable it?</a>' + "</div> ";
