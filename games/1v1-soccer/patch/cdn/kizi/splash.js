 ...
 * This is the Splash Screen for Orange G4M3S
 *
 * OrangeG4M3S
 * Build at 30-01-2019
 */
...
!function(a) {
    ...
    var c = function() {
        ...
        c.preloadImages = function(b) {
            var d;
            switch (a.Utils.isOnDevice(b) || c.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "/repository/download/Fabrique_FunnyG4M3SSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "https://" + window.location.host + "/orange-G4M3S-splash/assets/"),
            ...
            case a.BrandingDomain.Kizi:
                d = "kizi";
                break;
            case a.BrandingDomain.FunnyG4M3S:
                d = "funnyG4M3S"
            }
...
!function(a) {
    var b = function() {
        ...
        return b.loadPortalScript = function(b) {
            b && b.hasOwnProperty("minijuegos") && b.minijuegos.indexOf(a.Utils.getSourceSite()) !== -1 && (void 0 !== window.mpConfig ? window.mpConfig.partner = "orange-G4M3S" : window.mpConfig = {
                partner: "orange-G4M3S"
            },
            ...
            b && b.hasOwnProperty("newgrounds") && b.newgrounds.indexOf(a.Utils.getSourceSite()) !== -1 && addScript("https://cdn.fbrq.io/orange-G4M3S-splash/assets/scripts/newgroundsio.min.js", Date.now() / 1e3)
        }
        ,
        b
    }();
...
!function(a) {
    var b = function() {
        ...
        return a.initialize = function(b, c, d, e) {
            ...
            }(window, document, "script", "patch/js/null.js?//video-static.vooxe.com/libs/gd/gd.js", "gdPlayer", void 0, void 0),
            gdPlayer(i)
        }
        ,
        a.play = function(b) {
    ...
    !function(a) {
        var b = function(a) {
            ...
            b.prototype.openGame = function() {
                this.game.analytics && this.game.analytics.google.sendGenericEvent("MoreG4M3S", "Click", this.id),
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            function d(b, d) {
                var e = c.call(this, b, null, "moreG4M3S-background") || this;
                e.size = 800,
                e.items = [],
                e.offset = 14,
                e.isDestroyed = !1,
                ...
                e.logoBtn = e.game.add.button(0, -(e.background.height / 2) + e.offset, a.Branding.LOGO_KEY, function() {
                    a.Branding.openCampaignLink(e.game, e.gameName, a.UtmTargets.more_G4M3S)
                }, e),
                ...
                e.moreG4M3SBtn = b.add.button(0, e.background.y + e.background.height / 2 - g.height - e.offset, "", function() {
                    a.Branding.openCampaignLink(e.game, e.gameName, a.UtmTargets.more_G4M3S)
                }, e),
                e.moreG4M3SBtn.texture = g.generateTexture(),
                e.moreG4M3SBtn.input.priorityID = 680,
                e.moreG4M3SBtn.anchor.set(.5, 0),
                e.menuGrp.add(e.moreG4M3SBtn);
                var h = {
                    font: "bold 26px Tahoma",
                    fill: "#ffffff"
                };
                return e.moreG4M3SText = b.add.text(0, e.moreG4M3SBtn.height / 2 + 2, "PLAY MORE G4M3S", h),
                e.moreG4M3SText.anchor.set(.5),
                e.moreG4M3SBtn.addChild(e.moreG4M3SText),
                e.visible = !1,
                e.resize(),
            ...
            d.prototype.show = function() {
                this.visible || (this.game.analytics && (this.game.analytics.google.sendScreenView("moreG4M3S"),
                this.game.analytics.google.sendGenericEvent("MoreG4M3S", "Open")),
                this.visible = !0)
            }
            ,
            d.prototype.hide = function() {
                this.visible && (this.visible = !1,
                this.game.analytics && this.game.analytics.google.sendGenericEvent("MoreG4M3S", "Close"),
                this.onClose && this.onClose.dispatch())
            }
            ,
            d.preloadImages = function(b) {
                a.Utils.getSourceSite();
                a.Utils.isOnDevice(b) || a.Branding.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "/repository/download/Fabrique_FunnyG4M3SSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "//" + window.location.host + "/orange-G4M3S-splash/assets/"),
                a.Utils.isTc() || (b.load.crossOrigin = "anonymous"),
            ...
            d.prototype.destroy = function() {
                ...
                this.closeBtn = null,
                this.moreG4M3SBtn.destroy(),
                this.moreG4M3SBtn = null,
                this.moreG4M3SText.destroy(),
                this.moreG4M3SText = null,
    ...
    !function(b) {
        var c = function(c) {
            ...
            d.prototype.init = function(b) {
                ...
                a.Utils.isOnDevice(this.game) || a.Branding.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "/repository/download/Fabrique_FunnyG4M3SSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "https://" + window.location.host + "/@orange-G4M3S/splash/assets/"),
            ...
            d.prototype.preload = function() {
                ...
                this.game.load.json(a.Branding.GAME_ICONS_KEY, a.Utils.ASSET_LOCATION + "json/G4M3S.json?v=" + b),
                this.game.load.json(a.Domain.KEY, a.Utils.ASSET_LOCATION + "json/domains.json"))
            }
            ,
            d.prototype.getScale = function() {
                return this.game.device.desktop ? this.game.width < 1.5 * b.FunnyG4M3S.IdealWidth ? this.game.width / 6 * 4 / b.FunnyG4M3S.IdealWidth : 1 : this.game.width < this.game.height ? this.game.width / 6 * 4 / b.FunnyG4M3S.IdealWidth : this.game.width / 6 * 3 / b.FunnyG4M3S.IdealWidth
            }
            ,
            ...
            d.prototype.create = function() {
                ...
                case a.BrandingDomain.Bild:
                    ...
                    break;
                case a.BrandingDomain.FunnyG4M3S:
                    this.background = new a.SplashScreenBackgrounds.FunnyG4M3S(this.game,this.scaleFactor),
                    this.game.add.existing(this.background)
                }
        ...
        var c = function(c) {
            ...
            d.prototype.create = function() {
                ...
                case a.BrandingDomain.Bild:
                    ...
                    break;
                case a.BrandingDomain.FunnyG4M3S:
                    this.game.state.add(b.FunnyG4M3S.Name, b.FunnyG4M3S),
                    this.game.state.start(b.FunnyG4M3S.Name, !0, !1, this.config, this.background)
                }
            }
            ,
            d
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.animateButton = function() {
              console.l0g("--fx--animateButton--6--");
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.animateButton = function() {
              console.l0g("--fx--animateButton--7--");
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.game.tweens.remove(this.buttonTween),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !0,
                this.buttonTween = this.game.add.tween(this.playButton.scale),
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.handler = function(a, b) {
              console.l0g("--fx--handler--10--",a,b);              
                if (1==1 || !this.clicked && "mouseout" !== b.type) {
                    this.clicked = !0,
                    this.game.tweens.remove(this.buttonTween),
                    this.game.camera.fade(0, 250);
                    var c = this.game.add.tween(this.playButton.scale);
            ...
            ,
            d.prototype.animateButton = function() {              
              console.l0g("--fx--animateButton--");
              this.game.state.start(this.config.nextState);
              return true;
              
              // this.game.tweens.remove(this.buttonTween);
              // console.trace("--fx--animateButton--");
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.game.tweens.remove(this.buttonTween),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !0,
                this.buttonTween = this.game.add.tween(this.playButton.scale),
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.getScale = function() {
                return a.Utils.isOnDevice(this.game) ? this.game.width < 1.5 * b.FunnyG4M3S.IdealWidth ? this.game.width / 6 * 4 / b.FunnyG4M3S.IdealWidth : 1 : this.game.width < this.game.height ? this.game.width / 6 * 4 / b.FunnyG4M3S.IdealWidth : this.game.width / 6 * 3 / b.FunnyG4M3S.IdealWidth
            }
            ,
            d.prototype.startAnimation = function() {}
            ,
            d.prototype.animateButton = function() {
              console.l0g("--fx--animateButton--2--");
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.game.tweens.remove(this.buttonTween),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !0,
                this.buttonTween = this.game.add.tween(this.playButton.scale),
    ...
    !function(a) {
        var b = function(b) {
            ...
            c.prototype.animateButton = function() {
                var a = this;
              console.l0g("--fx--animateButton--3--");
...
!function(a) {
    ...
    !function(b) {
        var c = function(c) {
            ...
            ,
            d.prototype.animateButton = function() {
              console.l0g("--fx--animateButton--4--");
                return this.config.showPlayButton === !1 ? this.handler(this.game.input.pointer1, new MouseEvent("mousedown")) : (this.game.tweens.remove(this.buttonTween),
                this.playButton.scale.set(this.scaleFactor),
                this.playButton.visible = !0,
                this.buttonTween = this.game.add.tween(this.playButton.scale),
...
!function(a) {
    ...
    !function(a) {
        var b = function(b) {
            ...
            ,
            c.prototype.getScale = function() {
                return this.game.width < this.game.height ? this.game.width / 6 * 4 / a.FunnyG4M3S.IdealWidth : this.game.width / 6 * 3 / a.FunnyG4M3S.IdealWidth
            }
            ,
            c.prototype.startAnimation = function() {}
            ,
            c.prototype.animateButton = function() {
              console.l0g("--fx--animateButton--5--");
...
!function(a) {
    var b = function() {
        ...
        b.getBrandingDomain = function() {
            ...
            case "funnyG4M3S.nl":
                return a.BrandingDomain.FunnyG4M3S
            }
        }
        ,
        ...
        ,
        b.isTc = function() {
            return /(teamcity\.ds\.orangeG4M3S\.com)/.test(window.location.host)
        }
        ,
    ...
    b.ASSET_LOCATION = "patch/cdn/kizi/",
    a.Utils = b
}(Fabrique || (Fabrique = {}));
...
!function(a) {
    ...
    var c = function() {
        ...
        b.API_URL = "patch/json/null.json?" + ("https:" === document.location.protocol ? "https" : "http") + "://api.gameanalytics.com/v2/",
        b.instance = null,
        b
    }();
    a.GameAnalytics = c
