    ...
    i.n = e => {
        ...
        var $e = function() {
            ...
            it = function() {
                ...
                return e.prototype.init = function(e) {
                    ...
                    }, this.setupDefaultEvents(), dt.setupDefaultEvents(), e.GetIsPokiIFrame() && _e(), setTimeout(w.trackSaveG4M3S, 1e4);
                    var b = $e({}, l),
                        y = Ge;
                    r.debug && (y = function() {
        ...
        var ht = function() {
            ...
            mt = function() {
                function t() {
                    var t = this;
                    this.G4M3Started = !1, this.SDK = new nt, this.gameplayStartCounter = 0, this.gameplayStopCounter = 0, this.duringGameplay = !1, this.init = function(e) {
                        ...
                        t.gameplayStartCounter++, t.duringGameplay = !0, t.G4M3Started || (t.G4M3Started = !0, dt.track(n.tracking.screen.firstRound), t.SDK.startStartAdsAfterTimer()), dt.track(n.tracking.screen.gameplayStart, ht(ht({}, e), {
