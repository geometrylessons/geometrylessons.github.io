		...
		var backupApps = [
			{
				...
				name: "Fruita Crush",
				thumb:
					"/x-proxy-img/portal/html5G4M3S/images/tmp/180/FruitaCrushTeaser.jpg"
			},
			{
				id: "famobi/solitaire-classic",
				name: "Solitaire Classic",
				thumb:
					"/x-proxy-img/portal/html5G4M3S/images/tmp/180/SolitaireClassicTeaser.jpg"
			},
			{
				id: "famobi/smarty-bubbles-xmas",
				name: "Smarty Bubbles X-MAS EDITION",
				thumb:
					"/x-proxy-img/portal/html5G4M3S/images/tmp/180/SmartyBubblesXmasTeaser.jpg"
			},
			{
				id: "famobi/jewelish",
				name: "Jewelish",
				thumb:
					"/x-proxy-img/portal/html5G4M3S/images/tmp/180/Jewelish_Teaser.jpg"
			},
			{
				id: "famobi/archery-world-tour",
				name: "Archery World Tour",
				thumb:
					"/x-proxy-img/portal/html5G4M3S/images/tmp/180/ArcheryWorldTourTeaser.jpg"
			},
			{
				id: "famobi/penalty-shooters-2",
				name: "Penalty Shooters 2",
				thumb:
					"/x-proxy-img/portal/html5G4M3S/images/tmp/180/PenaltyShooters2Teaser.jpg"
			},
			{
				id: "famobi/wedding-lily",
				name: "Wedding Lily",
				thumb:
					"/x-proxy-img/portal/html5G4M3S/images/tmp/180/WeddingLilyTeaser.jpg"
			}
		];
...
fg_api.prototype.init = function () {
	...
	self.config.blurred_thumb =
		self.config.blurred_thumb ||
		"/x-proxy-img/portal/html5G4M3S/images/tmp/blurred/RacingMonsterTrucksTeaser.jpg";
