            ...
            (this.G4M3Started = !1),
              ...
              (this.gameplayStart = function (e) {
                ...
                n.ignoreEvents()
                  ...
                  : ((n.duringGameplay = !0),
                    n.G4M3Started || ((n.G4M3Started = !0), o.Z.track(i.Z.tracking.screen.firstRound), n.monetization.startStartAdsAfterTimer()),
              ...
              (this.commercialBreak = function (e) {
                return new Promise(function (t) {
                  ...
                  var o = n.G4M3Started ? i.Z.ads.position.midroll : i.Z.ads.position.preroll;
              ...
              return ve(this, function (d) {
                switch (d.label) {
                  ...
                  case 3:
                    (n = d.sent()), (d.label = 4);
                  case 4:
                    return (s = { screenshot: n, errors: (0, fe.FU)() }), e.callback && (s.callback = e.callback), o.Z.sendMessage(i.Z.message.sendG4M3Screenshot, { data: s }), [2];
                }
              });
            });
          },
  ...
  (a.m = o),
    ...
    (() => {
      ...
      var d,
        c,
        l = function () {
          n.Z.isPokiIframe && (setTimeout(o.Z.trackSaveG4M3S, 1e4), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && s());
        },
        u = !1,
        p = !1,
        A = 0,
              ...
              { code: ne, mediaTypes: a.mediaTypes, bids: te([], a.bids, !0) },
              {
                ...
                bids: te(
                  ...
                  [
                    ...
                    { bidder: "adagio", params: { organizationId: "1155", site: "poki-com", useAdUnitCodeAsPlacement: !0, useAdUnitCodeAsAdUnitElementId: !0, environment: "desktop", pagetype: "game", category: "G4M3S" } },
                  ],
                  !1
                ),
              },
