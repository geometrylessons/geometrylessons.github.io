	...
	'use strict';
{
	...
	const n = new Set(['cordova', 'playable-ad', 'instant-G4M3S']);
		...
		constructor(e) {
			(this.g_aYW = e.g_aYX),
				...
				('html5' === this.g_aps || 'playable-ad' === this.g_aps) &&
					...
					alert(
						"Exported G4M3S won't work until you upload them. (When running on the file: protocol, browsers block many features from working for security reasons.)"
					),
