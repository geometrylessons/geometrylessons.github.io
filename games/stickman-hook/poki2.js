! function(t) {
    ...
    var Lt = function() {
        ...
        Ot = new(function() {
            function t() {
                var t = this;
                this.G4M3Started = !1, this.SDK = new kt, this.gameplayStartCounter = 0, this.gameplayStopCounter = 0, this.init = function(n) {
                    ...
                    t.gameplayStartCounter++, t.G4M3Started || (t.G4M3Started = !0, y.track(A.tracking.screen.firstRound), t.SDK.startStartAdsAfterTimer()), y.track(A.tracking.screen.gameplayStart, Lt(Lt({}, n), {
                    ...
                    return new Promise((function(n) {
                        var e = t.G4M3Started ? A.ads.position.midroll : A.ads.position.preroll;
