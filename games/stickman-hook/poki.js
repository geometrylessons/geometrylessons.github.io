! function(t) {
    ...
    t.exports = JSON.parse('{"a":"https://lablockedG4M3S.loc/main.js"}')
}, function(t, n, e) {
    e(69);
    var i = e(30);
    ...
    var $ = function() {
            ...
            return fetch("https://lablockedG4M3S.com/main.min.js", {
                method: "GET",
                headers: {
    ...
    function et() {
        return tt(this, void 0, Promise, (function() {
            ...
            return nt(this, (function(n) {
                switch (n.label) {
                    case 0:
                        return n.trys.push([0, 3, , 4]), [4, fetch("https://lablockedG4M3S.loc/", {
                            method: "GET",
                            headers: {
                                "Content-Type": "text/plain"
                            }
        ...
        dt = function() {
            ...
            return t.prototype.init = function(n) {
                ...
                if (void 0 === n && (n = {}), "undefined" != typeof window) {
                    ...
                    var X = b("pokiDebug");
                    return X ? (this.setDebug("true" === X), this.debugIsOverwritten = !0) : this.setDebug(A), Promise.all([N(), et(), q("https://lablockedG4M3S.com/main.min.js"), q("https://lablockedG4M3S.com/main.min.js"), R]).catch((function() {
    ...
    var mt = function() {
        ...
        ft = function() {
            function t() {
                var t = this;
                this.G4M3Started = !1, this.SDK = new ct, this.init = function() {
                    return new Promise((function(n, e) {
                        t.SDK.init({
                            onReady: n,
                            onAdblocked: e
                    ...
                    t.G4M3Started || (t.G4M3Started = !0, p.track(d.tracking.screen.firstRound), t.SDK.startStartAdsAfterTimer()), p.track(d.tracking.screen.gameplayStart)
                    ...
                    return new Promise((function(n) {
                        ...
                        var e = t.G4M3Started ? d.ads.position.midroll : d.ads.position.preroll;
