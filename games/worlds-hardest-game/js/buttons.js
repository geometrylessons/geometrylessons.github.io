var buttons = [
  ...
  function correctButtonsTerms(name) {
    var group = 0;
    var group1 = ["ig_resumeGame", "ig_mainMenu", "ig_levelSelect", "ig_playerColor", "ig_muteSFX", "ig_muteMusic", "ig_playerBouncing", "ig_coolmathG4M3S", "ig_stephenCritoph"];
  ...
  function clickButtons() {
    ...
    /*
      else if (onButton("mm_coolmathG4M3S")) {
          playSFX(sfx_click);
          justClicked = true;
          window.open(LINK_COOLMATH, "_blank");
      }
    ...
    /*
      else if (onButton("ig_coolmathG4M3S")) {
          if (paused) {
              playSFX(sfx_click);
              justClicked = true;
              window.open(LINK_COOLMATH, "_blank");
