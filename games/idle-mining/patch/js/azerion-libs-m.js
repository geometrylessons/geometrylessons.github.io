...
!function(global, factory) {
    ...
    BrandingDomain[BrandingDomain.FunnyG4M3S = 3] = "FunnyG4M3S",
    ...
    var Hosts = function() {
        ...
        Hosts.isYandex = function() {
            return window.hasOwnProperty("_YaSDK") || window.hasOwnProperty("YaG4M3S")
        }
        ,
        Hosts.getYandexBaseURL = function() {
            var _a, _a;
            var lang;
            if (null != (_a = null == (_a = window.YandexG4M3SSDKEnvironment) ? void 0 : _a.browser) && _a.lang && "en" === window.YandexG4M3SSDKEnvironment.browser.lang)
                return "yandex.com";
            return "yandex.ru"
        }
        ,
    ...
    BrandingDomain[BrandingDomain.more_G4M3S = 6] = "more_G4M3S",
    ...
    var CrossPromo = function() {
        ...
        CrossPromo.getDomainURL = function(domain, protocol) {
            ...
            case exports.BrandingDomain.Bild:
                ...
                break;
            case exports.BrandingDomain.FunnyG4M3S:
                url = protocol + "www.funnyG4M3S.nu";
                break;
        ...
        CrossPromo.getPromoURL = function(domain, url, host, gameTitle, utmContent) {
            return window.hasOwnProperty("_YaSDK") || window.hasOwnProperty("YaG4M3S") ? "https://".concat(Hosts.getYandexBaseURL(), "/G4M3S/developer?name=Azerion") : domain === exports.BrandingDomain.Admeen ? "https://media.admeen.com/branding/link.php" : domain === exports.BrandingDomain.Bild ? url : url + "/?utm_source=" + host + "&utm_medium=html5&utm_term=" + gameTitle + "&utm_content=" + utmContent + "&utm_campaign=Gamedistribution"
        }
        ,
        CrossPromo
    }();
    ...
    var PortalScripts = function() {
        ...
        return PortalScripts.loadPortalScript = function(siteLockList) {
            siteLockList && siteLockList.hasOwnProperty("minijuegos") && -1 !== siteLockList.minijuegos.indexOf(Utils.getSourceSite()) && (void 0 !== window.mpConfig ? window.mpConfig.partner = "orange-G4M3S" : window.mpConfig = {
    ...
    var Branding = function() {
        ...
        Object.defineProperty(Branding, "brandingLogoUrl", {
            get: function() {
                return "patch/images/G4M3S235-banner.png";
                var imageName;
    ...
    var Utils = function() {
        ...
        Utils.getBrandingDomain = function() {            
            ...
            case "funnyG4M3S.nl":
                return exports.BrandingDomain.FunnyG4M3S;
            case "playtime.nl":
                ...
                var JioAdProvider = function() {
                    function JioAdProvider(config) {
                        ...
                        try {
                            ...
                            console.log("Could not initialize Jio G4M3S SDK", err)
                        }
                    }
                    ...
                    JioAdProvider.prototype.showAd = function(adType, adSpotKey) {
                        ...
                        this.adAvailable(adType)) {
                            ...
                            1) && (window.onAdView = function(cbAdSpot) {
                                setTimeout(function() {
                                    console.log("JioG4M3S ads: onAdView " + cbAdSpot),
                            ...
                            1) && (window.onAdClosed = function(data, pIsVideoCompleted, pIsEligibleForReward) {
                                ...
                                setTimeout(function() {
                                    console.log("JioG4M3S ads: onAdClose"),
                                    _this.resumeGameplay()
                                }, 3e3)
                            }
                            ),
                    ...
                    JioAdProvider.prototype.preloadAd = function(adType, adSpotKey) {
                        ...
                        1) && (window.onAdFailedToLoad = function(data, pDescription) {
                            ...
                            try {
                                ...
                                console.log("JioG4M3S: onAdFailedToLoad => ".concat(data.toString(), " => ").concat(pDescription))
                            } catch (e) {
            ...
            void 0 !== (exports = function(require, exports, shared_1) {
                ...
                var YandexAdProvider = function() {
                    ...
                    YandexAdProvider.prototype.initialize = function() {
                        var _this = this;
                        window.YaG4M3S.init().then(function(ysdk) {
                            window._YaSDK = ysdk,
                            _this.adsEnabled = !0
                        })
                    }
